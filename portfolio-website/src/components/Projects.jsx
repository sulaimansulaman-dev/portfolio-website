    ...
    <section className="p-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p>
            Built with React, Tailwind, Firebase, Electron. Supports
            private/group chats.
          </p>
          <a
            href="https://github.com/sulaimansulaman-dev/Messaging-App"
        ...
        <div>
          ...
          <a
            href="https://github.com/sulaimansulaman-dev/roadrunner-rental-system"
            className="text-blue-600 underline"
          >
            View Project
          </a>
        ...
        <div>
          ...
          <a
            href="https://github.com/sulaimansulaman-dev/ip-conflict-arcademia-game-jam"
            className="text-blue-600 underline"
          >
            View Project
          </a>
